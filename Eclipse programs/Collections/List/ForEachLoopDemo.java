...
public class ForEachLoopDemo {
	...
	public static void main(String[] args) {
		...
		ll.add(30.45);
		ll.add("Apple");
		//As there are heterogeneous objects, we can use Object class as a non-primitive data type because it is inherited by all the classes(wrapper classes as well).
		for(Object obj : ll) {
